...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        """
        domains_origin = copy.deepcopy(self.domains)
        for item in domains_origin.items():
            variable, words = item
            for word in words:
    ...
    def revise(self, x, y):
        ...
        if overlaps is not None:
            i, j = overlaps
            for word_x in domains_origin[x]:
                flag = False
                for word_y in domains_origin[y]:
    ...
    def consistent(self, assignment):
        ...
        for variable1 in assignment.keys():     # this may be costy
        ...
        for variable1 in assignment.keys():
            for variable2 in self.crossword.neighbors(variable1):
                if variable2 not in assignment.keys():
                    continue
